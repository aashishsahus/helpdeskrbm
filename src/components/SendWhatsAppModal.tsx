      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden border border-gray-200">
        ...
        {sentSuccess ? (
          <div className="p-10 text-center space-y-3">
            ...
            <h4 className="text-xl font-bold text-gray-900">WhatsApp Window Opened!</h4>
            <p className="text-sm text-gray-600">The message was dispatched and recorded into your delivery history logs.</p>
          </div>
        ) : (
          <form onSubmit={handleSendWhatsApp} className="p-6 space-y-4">
            ...
            <div className="bg-[#e5ddd5] p-3 rounded-xl border border-[#d1c7bc]">
              ...
              <div className="bg-[#d9fdd3] text-gray-800 p-3 rounded-xl rounded-tr-none shadow-xs text-xs font-sans whitespace-pre-wrap max-h-36 overflow-y-auto leading-relaxed border border-[#c4e6be]">
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              <button
                ...
                className="px-6 py-2.5 bg-emerald-600 hover:bg-emerald-700 disabled:opacity-50 text-white text-sm font-bold rounded-xl shadow-md hover:shadow-lg transition-all flex items-center gap-2"
              >
