...
export const initialTickets: Ticket[] = [
  {
    ...
    department: 'IT Operations',
    location: 'RPR',
    ticketType: 'Modification Request',
    category: 'Orbit',
    module: 'Invoice',
    subCategory: 'Add Item',
    subject: 'Orbit Invoice - Add Item Modification',
    description: 'Need to add line items in Orbit Invoice system for pending billing.',
    priority: 'Medium',
    status: 'Open',
    assignedAgentId: 'u0',
    assignedAgentName: 'Misr Pr',
    createdDate: '2026-08-12 00:30',
    updatedDate: '2026-08-12 00:30',
    slaDueDate: '2026-08-12 08:30',
    slaStatus: 'Safe',
  ...
  },
  {
    ...
    employeeEmail: 'mispr@rathibuildmart.com',
    department: 'IT Operations',
    location: 'RPR',
    ticketType: 'Modification Request',
    category: 'FMS',
    module: 'Material',
    subCategory: 'Change QTY',
    subject: 'FMS Material Quantity Adjustment',
    description: 'Material quantity correction in FMS entry log for dispatch batch.',
    priority: 'High',
    status: 'In Progress',
    assignedAgentId: 'u0',
    assignedAgentName: 'Misr Pr',
    createdDate: '2026-08-12 00:31',
    updatedDate: '2026-08-12 00:35',
    slaDueDate: '2026-08-12 04:31',
    slaStatus: 'Safe',
    contactNumber: '+91 98765 43210',
    isRealTicket: true
  },
  {
    id: 'HD-000011',
    employeeId: 'EMP-1011',
    employeeName: 'Dhaneshwari',
    employeeEmail: 'accountsrpr@rathibuildmart.com',
    department: 'Accounts',
    location: 'RPR',
    ticketType: 'Approval Request',
    category: 'Orbit',
    module: 'Customer',
    subCategory: 'Customer Approve',
    subject: 'Orbit Customer Account Approval',
    description: 'New corporate customer onboarding verification and credit limit approval in Orbit.',
    priority: 'Medium',
    status: 'Open',
    assignedAgentId: 'u_dhaneshwari',
    assignedAgentName: 'Dhaneshwari',
    createdDate: '2026-08-12 01:00',
    updatedDate: '2026-08-12 01:00',
    slaDueDate: '2026-08-12 09:00',
    slaStatus: 'Safe',
    contactNumber: '+91 98765 43210',
    isRealTicket: true
  },
  {
    id: 'HD-000012',
    employeeId: 'EMP-1018',
    employeeName: 'Bhupendra',
    employeeEmail: 'intpurchase@rathibuildmart.com',
    department: 'Purchase',
    location: 'RPR',
    ticketType: 'New Request',
    category: 'FMS',
    module: 'Entry',
    subCategory: 'New Entry',
    subject: 'FMS Inward Material Entry Setup',
    description: 'Creation of new gate entry records and vendor tag in FMS.',
    priority: 'Medium',
    status: 'Resolved',
    assignedAgentId: 'u_bhupendra',
    assignedAgentName: 'Bhupendra',
    createdDate: '2026-08-11 10:15',
    updatedDate: '2026-08-11 14:30',
    resolvedDate: '2026-08-11 14:30',
    slaDueDate: '2026-08-11 18:15',
    slaStatus: 'Safe',
    contactNumber: '+91 98765 43210',
    rating: 5,
    feedback: 'FMS entry completed quickly.',
    isRealTicket: true
  },
  {
    id: 'HD-000013',
    ...
    category: 'Hardware',
    module: 'Desktop/Laptop',
    subCategory: 'Laptop',
    subject: 'Laptop Display & Corporate VPN Setup',
    ...
    assignedAgentName: 'Misr Pr',
    createdDate: '2026-08-12 00:31',
    updatedDate: '2026-08-12 00:53',
    slaDueDate: '2026-08-12 08:31',
    resolvedDate: '2026-08-12 00:53',
    slaStatus: 'Safe',
    contactNumber: '+91 98765 43210',
    rating: 5,
